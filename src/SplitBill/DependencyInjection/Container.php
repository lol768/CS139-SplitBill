...
use ReflectionClass;
use SplitBill\Exception\ContainerException;
...
class Container implements IContainer {
    ...
    public function __construct() {
        $this->singletonsMap = array("\\SplitBill\\DependencyInjection\\Container" => $this);
        $this->registerAbstractImplementation("\\SplitBill\\DependencyInjection\\IContainer", "\\SplitBill\\DependencyInjection\\Container");
    }
