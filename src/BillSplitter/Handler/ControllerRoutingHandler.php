...
namespace BillSplitter\Handler;

use ReflectionMethod;
use BillSplitter\Controller\AbstractController;
use BillSplitter\DependencyInjection\IContainer;
use BillSplitter\Exception\BadRequestException;
use BillSplitter\Exception\RequestHandlingException;
use BillSplitter\Filter\IFilterConfiguration;
use BillSplitter\Request\HttpRequest;
use BillSplitter\Response\AbstractResponse;
use BillSplitter\Response\ViewResponse;
use BillSplitter\Utilities\PhpCompatibility;
...
class ControllerRoutingHandler {
    ...
    private function getFullControllerName($controller) {
        return "\\BillSplitter\\Controller\\" . $controller;
    }
